"""Unit tests for src.evaluation.error_analysis."""
...
def test_categorize_examples_all_four_categories() -> None:
    baseline_records = [
        _make_record("improved_ex", "Q?", "yes", "no", "CLOSED"),      # baseline wrong
        _make_record("regressed_ex", "Q?", "yes", "yes", "CLOSED"),    # baseline right
        _make_record("both_correct_ex", "Q?", "yes", "yes", "CLOSED"),  # baseline right
        _make_record("both_wrong_ex", "Q?", "yes", "no", "CLOSED"),    # baseline wrong
    ]
    rag_records = [
        _make_record("improved_ex", "Q?", "yes", "yes", "CLOSED"),     # rag right -> improved
        _make_record("regressed_ex", "Q?", "yes", "no", "CLOSED"),     # rag wrong -> regressed
        _make_record("both_correct_ex", "Q?", "yes", "yes", "CLOSED"),  # rag right
        _make_record("both_wrong_ex", "Q?", "yes", "no", "CLOSED"),    # rag wrong
    ]
