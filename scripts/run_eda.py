...
def write_findings_markdown(rocov2_stats: dict | None, vqa_rad_stats: dict | None) -> None:
    ...
    if vqa_rad_stats:
        lines += [
            ...
            "",
            "![Answer type distribution](../experiments/logs/eda/vqa_rad_answer_type_distribution.png)",
        ...
        lines += [
            "## VQA-RAD (Evaluation Benchmark)",
            "",
            "_No manifest found — run `python scripts/download_data.py --dataset vqa_rad` first._",
            "",
        ]
