...
Category = str  # "improved" | "regressed" | "both_correct" | "both_wrong"
...
class CategorySummary(TypedDict):
    """Counts and a few example ids per category, for the human-readable report."""
...
def _is_correct(prediction: str, reference: str, answer_type: str) -> bool:
    ...
    return compute_rouge_l(prediction, reference) >= 0.5
